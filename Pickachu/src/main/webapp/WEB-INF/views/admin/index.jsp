  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">${indexUser.nickName }</a>
        </div>
      </div>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-left">${indexUser.nickName }</span>
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="${pageContext.request.contextPath}/resources/admin/dist/img/user1-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="${pageContext.request.contextPath}/resources/admin/dist/img/user7-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="${pageContext.request.contextPath}/resources/admin/dist/img/user3-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="${pageContext.request.contextPath}/resources/admin/dist/img/user5-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="${pageContext.request.contextPath}/resources/admin/dist/img/user6-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="${pageContext.request.contextPath}/resources/admin/dist/img/user8-128x128.jpg">
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  ...
                  <div class="col-4 text-center">
                    ...
                    <div class="text-white">Visit success</div>
                  </div>
                  <!-- ./col -->
                </div>
                <!-- /.row -->
...
<script src="${pageContext.request.contextPath}/resources/admin/plugins/jqvmap/maps/jquery.vmap.world.js"></script>
<!-- jQuery Knob Chart -->
