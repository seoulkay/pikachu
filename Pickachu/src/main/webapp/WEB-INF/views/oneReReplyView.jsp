...
<body>
<h3>
	<a href="/ccc/oneReplyView?postId=${reply.postId}&replyId=${reply.replyId}" style="text-decoration:none; color:black">is this the end of reply?  </a>
</h3>
...
<div class="row">
<form action="reReplyForm" id="myForm" method="GET">
	<input type="hidden" name="postId" value="${post.postId }">
	<input type="hidden" name="replyId" value="${reply.replyId }">
<%-- 	<input type="hidden" name="reReplyId" value="${reply.replyId }"> --%>
<!-- 	<input type="submit" value="댓댓글쓰기"> -->
	<button>
...
<hr color="#C4C4C4" size="1px">
    ...
    <c:forEach items="${reReplyList}" var="reRepl" begin="0">
    	<div class="row">   
			<div class="col-12 text-center">
			<a href="oneReplyView?postId=${reRepl.postId }&replyId=${reRepl.replyId}" style="text-decoration:none; color:red">
